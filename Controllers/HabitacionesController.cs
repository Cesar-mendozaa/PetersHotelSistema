...
namespace SistemaApartados.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public HabitacionesController(PetersHotelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NumeroHabitacion,Tipo,Precio,Disponibilidad,Descripcion,Capacidad,Servicios")] Habitacione habitacione)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NumeroHabitacion,Tipo,Precio,Disponibilidad,Descripcion,Capacidad,Servicios")] Habitacione habitacione)
        {
